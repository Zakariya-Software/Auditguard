...
# In-memory storage (Resets on restart - perfect for launch tonight)
USAGE_COUNTS = {}  
PAID_USERS = set() 
...
def analyze_contract_liability(text: str):
    ...
    # Simple logic to simulate AI detection
...
async def index():
    ...
    <head>
        ...
        <style>
            ...
            button { width: 100%; padding: 14px; border: none; border-radius: 8px; font-weight: bold; cursor: pointer; margin-bottom: 10px; }
            .btn-analyze { background: #0284c7; color: white; }
            .btn-pro { background: #16a34a; color: white; }
            #result { margin-top: 20px; padding: 15px; border-radius: 8px; display: none; background: #1e293b; border-left: 5px solid #38bdf8; }
        </style>
    </head>
    <body>
        <div class="card">
